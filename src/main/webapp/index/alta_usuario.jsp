								...
								<div class="row">
									...
									<div class="col-lg-6 col-12">
										<div class="form-group">
											...
											<input name="primer_apellido" type="text" placeholder="">
										</div>
									</div>
									<div class="col-lg-6 col-12">
										<div class="form-group">
									...
									<div class="col-lg-6 col-12">
										<div class="form-group">
											...
											<input name="password" type="password" autocomplete="current-passowrd">
										</div>
									</div>
									<div class="col-lg-6 col-12">
										<div class="form-group">
											<label>Repetir contraseña<span>*</span></label>
											<input name="repassword" type="password" autocomplete="current-passowrd">
										</div>
									</div>
