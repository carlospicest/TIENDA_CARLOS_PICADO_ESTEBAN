				...
				<div class="row justify-content-md-center">
					<div class="col-lg-8 col-12">
						<div class="form-main">
							...
							<form class="form" method="POST" action="producto_actualizar">
								<div class="row">
									<div class="col-12">
										<div class="form-group">
											<label>Nombre<span>*</span></label> <input name="nombre"
												type="text" placeholder="" value="<%= producto.getNombre() %>">
										</div>
									</div>
									<div class="col-12">
										<div class="form-group">
											<label>Descripción</label>
											<textarea rows="2" maxlength="255" name="descripcion"><%= producto.getDescripcion() %></textarea>
										</div>
									</div>
									...
									<div class="col-lg-6 col-12">
										<div class="form-group">
											<label>Precio<span>*</span></label> <input
												name="precio" type="number" value="<%= producto.getPrecio() %>">
										</div>
									</div>
									<div class="col-lg-6 col-12">
										<div class="form-group">
											<label>Stock<span>*</span></label> <input name="stock"
												type="number" value="<%= producto.getStock() %>">
										</div>
									</div>
									<div class="col-lg-6 col-12">
										<div class="form-group">
											<label>Impuesto<span>*</span></label> <input
												name="impuesto" type="number" value="<%= producto.getImpuesto() %>">
										</div>
									</div>
									<div class="col-lg-6 col-12">
										<div class="form-group">
											...
											<% if (producto.isBaja()) { %>
											<input type="checkbox" name="baja_producto" value="bajaProducto" checked>
											<% } else { %>
